 ...
 */
(function () {
  const SUPABASE_URL = "https://rgeofxtkcwjsyouzloed.supabase.co"; // CHANGE REQUIRED: replace with your Supabase project URL
  const SUPABASE_ANON_KEY = "sb_publishable_oDi-QnswVbpOHguT2E50hQ_0m4eSZFD"; // CHANGE REQUIRED: replace with your Supabase publishable anon key
